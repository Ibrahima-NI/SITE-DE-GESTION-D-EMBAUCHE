            ...
            <div class="container pb-xl-9 pb-5">
                <div class="row align-items-center g-4">
                    <div class="col-lg-6 col-md-12">
                        <div class="me-xl-8">
                            <h1 class="mb-3">Qui somme-nous.</h1>
                            <p class="lead mb-4">I&H : La plateforme idéale pour connecter talents et recruteurs.</p>
                            <p class="mb-6 me-xl-6">
                                I&H est une plateforme innovante dédiée à la mise en relation entre employeurs et chercheurs d'emploi. Conçu pour simplifier et optimiser le processus de recrutement, I&H offre aux entreprises la possibilité de publier leurs offres d'emploi et de découvrir des talents qualifiés grâce à des outils de recherche performants.
                            </p>

                            <p>
                                Les candidats, quant à eux, peuvent créer un profil professionnel, déposer leur CV et accéder à une multitude d'opportunités correspondant à leurs compétences et ambitions. Avec son interface conviviale et ses fonctionnalités modernes, I&H est la solution idéale pour répondre aux besoins du marché de l’emploi, en connectant efficacement les recruteurs et les talents.
                            </p>
                                ...
                                <div class="col-md-6">
                                    <ul class="list-unstyled mb-3">
                                        <li class="d-flex mb-3">
                                            ...
                                            <span class="ms-2">Une interface intuitive pour une navigation rapide et efficace.</span>
                                        </li>
                                        <li class="d-flex">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill text-primary opacity-75" viewbox="0 0 16 16">
                                            ...
                                            <span class="ms-2">Accès à une grande variété de profils et d’offres d’emploi.</span>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <ul class="list-unstyled mb-0">
                                        <li class="d-flex mb-3">
                                            ...
                                            <span class="ms-2">Accélère le processus de sélection grâce à des outils optimisés..</span>
                                        </li>
                                        <li class="d-flex">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-circle-fill text-primary opacity-75" viewbox="0 0 16 16">
                                            ...
                                            <span class="ms-2">Permet de suivre les candidatures et de gérer les offres facilement.</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row g-lg-7 gy-5">
                    <div class="col-lg-4 col-md-4 text-center">
                        ...
                        <h4>Connecter les Talents et les Opportunités</h4>
                        <p class="mb-0">Nous aspirons à devenir un pont incontournable entre les entreprises et les candidats, en offrant une plateforme où chacun peut trouver ce qu'il recherche.</p>
                    </div>
                    <div class="col-lg-4 col-md-4 text-center">
                        <div class="mb-5">
                        ...
                        <h4>Simplifier le Processus de Recrutement</h4>
                        <p class="mb-0">Notre objectif est de rendre le recrutement plus rapide, efficace et accessible grâce à des outils modernes et intuitifs.</p>
                    </div>
                    <div class="col-lg-4 col-md-4 text-center">
                        <div class="mb-5">
                        ...
                        <h4>Promouvoir un Marché de l'Emploi Inclusif</h4>
                        <p class="mb-0">Nous croyons en l'égalité des chances et en l'importance d'un marché de l’emploi ouvert à tous. Avec I&H, nous souhaitons encourager la diversité et permettre à chacun de trouver sa place.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-md-12">
                        <div class="text-center mb-xl-7 mb-5 mx-xl-8">
                            <h2 class="mb-0">Économisez du temps et de l'argent en choisissant notre équipe hautement performante.</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center card-lift">
                            <div class="card-body py-5">
                                ...
                                <h5 class="mb-1">Ibrahim Abdillahi</h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center card-lift">
                            <div class="card-body py-5">
                                ...
                                <h5 class="mb-1">Hassan Mahamoud</h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center card-lift">
                            <div class="card-body py-5">
                                ...
                                <h5 class="mb-1">Ifran Ibrahim</h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center card-lift">
                            <div class="card-body py-5">
                                ...
                                <h5 class="mb-1">Hawa Mahamoud</h5>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card text-center card-lift">
                            <div class="card-body py-5">
                                ...
                                <h5 class="mb-1">Hamzeh Ibrahim</h5>
                                <small>Developer</small>
                            </div>
                        </div>
                    </div>
